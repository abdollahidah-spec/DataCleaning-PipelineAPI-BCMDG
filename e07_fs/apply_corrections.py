"""
e07_fs/apply_corrections.py
================================
Applique les corrections manuelles saisies dans l'onglet "Instructions" d'un
fichier E07_FS_classification.xlsx vers les caches warm-start des champs
...
Usage (depuis la racine du repo) :
    python -m e07_fs.apply_corrections --file "e07_fs/outputs/E07_FS_classification.xlsx"
"""
...
def apply_corrections(file_path: str | Path, api_id: str, config_path: str | Path) -> dict:
    ...
    processors = {p.field_name: p for p in build_e07_field_processors(cfg)}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", required=True, help="Fichier E07_FS_classification.xlsx")
    parser.add_argument("--api-id", default=None, choices=_VALID_API_IDS)
    parser.add_argument("--config", default="e07_fs/config/E07_FS.yaml")
