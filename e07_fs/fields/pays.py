...
==========================
Normalisation du champ Pays pour E07_FS — porté depuis
...
cache (validated_classif_pays_e07_fs.json) — l'ancien repo ne cachait JAMAIS les
...
générique des autres champs, d'où une règle dédiée) :
  Pays vide/null  ET  ReferenceTransaction vide/null  →  NoAs   (bruit pur, les deux vides)
  Pays == 'NA'    ET  ReferenceTransaction non vide   →  'NA'   (Namibie, valeur légitime)
  Pays == 'NA'    ET  ReferenceTransaction vide       →  NoAs
  Valeur non-pays détectée par la cascade  →  OUTLIER (toujours, quel que soit ReferenceTransaction)
"""
...
# Valeurs considérées comme "vides" dans la colonne témoin (ReferenceTransaction)
