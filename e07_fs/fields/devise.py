"""
e07_fs/fields/devise.py
===========================
Normalisation du champ Devise pour E07_FS — logique IDENTIQUE à
...
cache warm-start diffère : scopé à E07_FS (validated_classif_devise_e07_fs.json).
...
RÈGLE NA — témoin ReferenceTransaction (confirmé, ancien repo devise/config/E07_FS.yaml :
ref_transaction: "ReferenceTransaction") :
  Devise == 'NA'  ET  ReferenceTransaction == 'NA'   → 'NA'
  Devise == 'NA'  ET  ReferenceTransaction != 'NA'   → OUTLIER
...
def load_warm_start_devise(api_id: str = "E07_FS") -> dict:
