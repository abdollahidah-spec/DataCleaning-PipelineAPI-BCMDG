"""
Extraction ad hoc E10_FE (e10_fe/ad_hoc_extraction.py) : même contrat que l'outil
E11 — nettoyage des champs dont les colonnes sont présentes, les autres ignorés.
"""
import pandas as pd

from e10_fe.ad_hoc_extraction import run_ad_hoc_extraction

CONFIG_PATH = "e10_fe/config/E10_FE.yaml"


def test_extraction_depuis_fichier_local(tmp_path):
    out_path = tmp_path / "export.csv"
    result_path = run_ad_hoc_extraction(
        CONFIG_PATH, input_file="tests/fixtures/e10_fe_sample.csv", output_path=str(out_path)
    )
