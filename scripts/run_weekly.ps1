...
# Cible unique du job Windows Task Scheduler (chaque lundi 10h) — lance les 3
# pipelines (E11_RDCC, E09_PE, E08_OCD) en mode incremental (delta uniquement,
# cf. shared/state_store.py). Chaque pipeline gere son propre succes/echec
# (email OK/KO, etat) : l'echec de l'un n'empeche pas le lancement des suivants.
#
