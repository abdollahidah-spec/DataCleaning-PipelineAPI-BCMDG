"""
e10_fe/apply_corrections.py
================================
Applique les corrections manuelles saisies dans l'onglet "Instructions" d'un
fichier E10_FE_classification.xlsx vers les caches warm-start des champs
...
Usage (depuis la racine du repo) :
    python -m e10_fe.apply_corrections --file "e10_fe/outputs/E10_FE_classification.xlsx"
"""
...
def apply_corrections(file_path: str | Path, api_id: str, config_path: str | Path) -> dict:
    ...
    processors = {p.field_name: p for p in build_e10_field_processors(cfg)}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", required=True, help="Fichier E10_FE_classification.xlsx")
    parser.add_argument("--api-id", default=None, choices=_VALID_API_IDS)
    parser.add_argument("--config", default="e10_fe/config/E10_FE.yaml")
