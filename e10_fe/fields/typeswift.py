"""
e10_fe/fields/typeswift.py
============================
Normalisation du champ TypeSwift pour E10_FE — portée depuis l'ancien repo
...
Référentiel : codes SWIFT valides PAR FLUX (`valid_fs` pour les Flux Entrants
d'E10), stockés sous forme canonique avec espaces (« MT 103 ») et comparés sans
espaces (« MT103 »).
...
def load_typeswift_referentiel(path, flux: str = "FE") -> TypeSwiftReferentiel:
...
def load_warm_start_typeswift(api_id: str = "E10_FE") -> dict:
...
def build_full_classification_typeswift(ref: TypeSwiftReferentiel, api_id: str,
    ...
    delta traité — même raisonnement que e10_fe/fields/devise.py."""
