"""
e10_fe/fields/devise.py
===========================
Normalisation du champ Devise pour E10_FE — logique IDENTIQUE à
...
cache warm-start diffère : scopé à E10_FE (validated_classif_devise_e10_fe.json).
...
RÈGLE NA — témoin ReferenceTransaction (confirmé, ancien repo devise/config/E10_FE.yaml :
...
def load_warm_start_devise(api_id: str = "E10_FE") -> dict:
