"""
e10_fe/fields/transactions.py
===============================
Moteur de validation des champs numériques/date d'E10_FE (Flux Entrants) —
...
règle NA des champs catégoriels d'E10 (shared/na_rule.py).
