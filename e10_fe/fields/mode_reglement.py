"""
e10_fe/fields/mode_reglement.py
=================================
Normalisation du champ ModeReglement pour E10_FE — portée depuis l'ancien repo
...
catégoriels d'E10 : un 'NA' n'est légitime que sur un message sans activité
...
def load_warm_start_mode_reglement(api_id: str = "E10_FE") -> dict:
