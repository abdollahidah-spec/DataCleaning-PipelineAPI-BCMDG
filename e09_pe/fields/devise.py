"""
e09_pe/fields/devise.py
==========================
Normalisation du champ Devise pour E09_PE — logique IDENTIQUE à
e11_rdcc/fields/devise.py (même cascade déterministe, même référentiel ISO
4217), dupliquée ici par choix architectural (decision H : chaque API est
autonome, pas de dépendance croisée entre packages e11_rdcc/e09_pe) plutôt que
partagée. Seul le cache warm-start diffère : scopé à E09_PE
(validated_classif_devise_e09_pe.json), indépendant de celui d'E11.
...
RÈGLE NA — témoin NumCredoc (confirmé) : un seul champ catégoriel pour E09 (pas
de risque d'incohérence entre plusieurs champs comme pour E11 avant son
correctif "NA globale" — voir e11_rdcc/global_na.py), donc le témoin simple
suffit ici :
...
def load_warm_start_devise(api_id: str = "E09_PE") -> dict:
...
def build_full_classification_devise(ref: DeviseReferentiel, api_id: str, col_in: str, col_out: str) -> pd.DataFrame:
    ...
    lignes du run en cours — voir e11_rdcc/fields/devise.py pour le raisonnement complet."""
